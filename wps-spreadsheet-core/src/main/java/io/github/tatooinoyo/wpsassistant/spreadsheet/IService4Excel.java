...
import io.github.tatooinoyo.wpsassistant.spreadsheet.api.port.ExcelDataPort;
 ...
 * @since 1.0
 */
public interface IService4Excel<T> extends IService4ImportExcel<T>, ExcelDataPort<T> {
