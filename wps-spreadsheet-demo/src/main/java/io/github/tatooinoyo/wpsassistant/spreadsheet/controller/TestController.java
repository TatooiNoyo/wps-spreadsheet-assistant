...
import io.github.tatooinoyo.wpsassistant.spreadsheet.adapter.servlet.ServletSpreadsheetSupport;
import io.github.tatooinoyo.wpsassistant.spreadsheet.input.ImportResult;
import io.github.tatooinoyo.wpsassistant.spreadsheet.spring.MultipartFileAdaptor;
...
public class TestController {
    ...
    public void exportExcel(HttpServletResponse response, @RequestParam List<String> ids) {
        ServletSpreadsheetSupport.exportExcel(testExcelService, response, ids);
    }
    ...
    public void downloadTemplate(HttpServletResponse response) {
        ServletSpreadsheetSupport.downloadTemplate(testExcelService, response);
    }
}
